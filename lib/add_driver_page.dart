                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: (school['routes'] as List)
                            ...
                            final routeLabel = "Start: $start → End: $end | Stops: $stops";
                      ...
                      return Column(
                        ...
                        children: [
                          ...
                          ...(s['routes'] as List).map<Widget>((r) {
                            // This may still have full map or string, so handle both:
                            if (r is Map) {
                              final start = r['start']?['name'] ?? '';
                              final end = r['end']?['name'] ?? '';
                              final stops = (r['stops'] as List?)?.map((s) => s['name']).join(', ') ?? '';
                              return Text("   - Start: $start → End: $end | Stops: $stops");
                            } else {
                              return Text("   - $r");
                            }
                          }).toList(),
